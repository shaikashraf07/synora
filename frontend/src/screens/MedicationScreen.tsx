...
import { ShieldPlus, ShieldAlert, Sparkles, Check, AlertTriangle, Pill, ArrowRight, Zap, Plus, Trash2 } from "lucide-react";
...
export default function MedicationScreen({
  ...
  onRemoveMedication?: ((drugName: string) => void) | undefined;
  ...
  return (
    <div className="space-y-6">
      ...
      <PatientSummaryCard
        ...
        footnote={
          readOnly
            ? `Viewing active medication list for ${patient.name}. You can add self-reported meds or remove expired ones.`
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <section className="space-y-3" aria-label="Current medications">
          ...
          {patient.medications.length === 0 ? (
            <div className="surface p-8 text-center text-sm text-muted-foreground">
              ...
              <p className="text-xs text-muted-foreground">Add a medication to populate your prescription list.</p>
            </div>
          ) : (
        ...
        {/* Doctor Prescribing & Patient Add Console */}
          ...
          <div className="surface relative overflow-hidden p-6 shadow-soft">
            <div className="flex items-center justify-between">
              <h2 className="flex items-center gap-2 text-base font-bold tracking-tight text-foreground">
                ...
                {readOnly ? "Add Self-Reported Medication" : "Prescribe New Medication"}
              </h2>
            ...
            <p className="mt-1.5 text-xs leading-relaxed text-muted-foreground">
              {readOnly
                ? "Self-report an over-the-counter or prescribed medication to keep your complete medication history safe."
              ...
              >
                {checking ? (
                  ...
                  <>
                    ...
                    Run Safety Check & Add Medication
                  </>
                )}
              </button>
            </form>
            ...
            <AlertBanner
              ...
              footer={
                <div className="flex items-center gap-2 text-xs font-semibold text-rose-800">
                  ...
                  Prescription flagged. Clinician review required before administration.
                </div>
              }
            >
          ...
          {result?.status === "added" && (
            ...
            >
              <p className="text-xs text-emerald-950">
                <span className="font-bold">{result.drug}</span> passed all interaction and cross-record safety checks. Added to active medication list.
              </p>
            </AlertBanner>
          )}
          ...
          {!result && !checking && (
            <div className="rounded-2xl border border-teal-500/20 bg-gradient-to-br from-slate-50 via-teal-50/40 to-indigo-50/40 p-5 shadow-xs">
              ...
              <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
                Try clicking the test buttons above to demo how the safety engine prevents dangerous interactions even when past diagnostic records are kept confidential by the patient.
              </p>
            </div>
          )}
        </section>
